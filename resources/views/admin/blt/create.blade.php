<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Data Penerima Bantuan') }}
        </h2>
    </x-slot>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <select id="status_penerima" name="status_penerima" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    <option value="Layak" {{ old('status_penerima') == 'Layak' ? 'selected' : '' }}>Layak</option>
                                    <option value="Tidak Layak" {{ old('status_penerima') == 'Tidak Layak' ? 'selected' : '' }}>Tidak Layak</option>
                                    <option value="Diterima" {{ old('status_penerima') == 'Diterima' ? 'selected' : '' }}>Diterima</option>
                                </select>
