                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <form action="{{ route('admin.blt.destroy', $b) }}" method="POST" class="inline-block" onsubmit="event.preventDefault(); desaConfirm('Yakin ingin menghapus data bantuan ini?', () => this.submit()); return false;">
                                        @csrf
                                        @method('DELETE')
