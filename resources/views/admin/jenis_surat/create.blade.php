                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2 space-y-2">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="persyaratan_dokumen[]" value="KTP" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ (is_array(old('persyaratan_dokumen')) && in_array('KTP', old('persyaratan_dokumen'))) ? 'checked' : '' }}>
                                        <span class="ml-2">KTP</span>
                                    </label>
                                    <br>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="persyaratan_dokumen[]" value="KK" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ (is_array(old('persyaratan_dokumen')) && in_array('KK', old('persyaratan_dokumen'))) ? 'checked' : '' }}>
                                        <span class="ml-2">Kartu Keluarga (KK)</span>
                                    </label>
                                    <br>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="persyaratan_dokumen[]" value="Akta Kelahiran" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ (is_array(old('persyaratan_dokumen')) && in_array('Akta Kelahiran', old('persyaratan_dokumen'))) ? 'checked' : '' }}>
                                        <span class="ml-2">Akta Kelahiran</span>
                                    </label>
                                    <br>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="persyaratan_dokumen[]" value="Surat Pengantar RT/RW" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ (is_array(old('persyaratan_dokumen')) && in_array('Surat Pengantar RT/RW', old('persyaratan_dokumen'))) ? 'checked' : '' }}>
                            ...
                            <div>
                                ...
                                <select id="jenis_validasi" name="jenis_validasi" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="langsung" {{ old('jenis_validasi') === 'langsung' ? 'selected' : '' }}>Persetujuan Langsung (Admin Sahaja)</option>
                                    <option value="tte_kades" {{ old('jenis_validasi') === 'tte_kades' ? 'selected' : '' }}>Tanda Tangan Elektronik (Wajib Persetujuan Kades)</option>
                                    <option value="basah" {{ old('jenis_validasi') === 'basah' ? 'selected' : '' }}>Tanda Tangan Basah (Manual)</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="kode_surat" name="kode_surat" type="text" class="mt-1 block w-full" :value="old('kode_surat')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="format_nomor" name="format_nomor" type="text" class="mt-1 block w-full" :value="old('format_nomor')" placeholder="[KODE]/[NOMOR]/DS/[TAHUN]" />
                            ...
                            <div>
                                ...
                                <textarea id="template_konten" name="template_konten" class="summernote">{{ old('template_konten') }}</textarea>
